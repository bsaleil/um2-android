...
public class TabViewActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tab.setText(label1);
        TabListener<BuildingListTab> tl = new TabListener<BuildingListTab>(this, label1, BuildingListTab.class);
        ...
        tab.setText(label2);
        TabListener<OtherListTab> tl2 = new TabListener<OtherListTab>(this,label2, OtherListTab.class);
